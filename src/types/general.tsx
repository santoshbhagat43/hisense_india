...
export interface TechnologyPageData {
  ...
  acf: {
    ...
    }[]; // it's an array, but contents are not specified in prompt
    page_section: {
      acf_fc_layout: string;
      banner_image: {
        ID: number;
...
export interface ValuesPageData {
  ...
  acf: {
    banner_data: {
      acf_fc_layout: string; // "banner_data"
    ...
    section_title: string;
    section_data: (
      | { acf_fc_layout: "title"; section_title: string }
      | { acf_fc_layout: "text_data"; title: string; description: string }
      | {
          acf_fc_layout: "text_image_data";
          image: {
            ID: number;
            id: number;
            title: string;
      ...
      | { acf_fc_layout: "description_data"; description: string }
      | {
          acf_fc_layout: "banner_data";
