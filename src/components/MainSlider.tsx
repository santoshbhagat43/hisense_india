...
import { BannerData } from "@/types/general";
...
const MainSlider = ({ slides = [] }: { slides?: BannerData[] }) => {
        ...
        <Slider {...sliderSettings}>
          {slides.map((slide, idx) => (
            <div className="slide-item" key={idx}>
              <div
                className={slide.content ? "content" : "content align-center"}
              >
              ...
              <img
                ...
                src={slide.banner_image_desktop?.url ?? ""}
                alt={slide.banner_title}
              />
              <img
                className="banner mobile-only"
                src={slide.banner_image_mobile?.url ?? ""}
                alt={slide.banner_title}
              />
            </div>
          ))}
