...
export const metadata: Metadata = {
  title: "Product Warranty Information - Hisense Global",
  description: "Hisense India - Product warranty information and terms for all products",
  keywords: "Hisense India, Warranty Information, Product Warranty, Support, Customer Service",
};

export default function ProductWarrantyInformationPage() {
  return (
    <div className="page-wrapper">
      <div className="main-container">
        <div className="breadcrumb__banner">
          <h1>Product Warranty Information</h1>
        </div>
            ...
            <div className="content-item" id="b20">
              ...
              <div className="terms__and__conditions__context__text">
                <ul>
                  ...
                  <li>
                    Download template, upload with hashtags #HisenseIndia #B20WithHisense.
                  </li>
                  <li>Follow page, tag 3 friends, must be 18+.</li>
                  <li>
                    Top 30 participants get Jio Cinema subscription for a year.
                  </li>
                </ul>
              </div>
            </div>
